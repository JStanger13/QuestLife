...
import example.com.quest.Fragments.CreateUserFragment;
import example.com.quest.Fragments.StoryFragment;
import example.com.quest.Fragments.WelcomeFragment;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void saveUser(UserProfileObject user){
        Singleton.getInstance().setUserProfileObject(user);

        helper = new SQLiteHelper(this);
        helper.createUserProfile(user);
        Intent mainQuestIntent = new Intent(LoginActivity.this, MainActivity.class);

        //Toast.makeText(LoginActivity.this, user.getImage(), Toast.LENGTH_SHORT).show();

        startActivity(mainQuestIntent);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageControl.setViewPager(mViewPager);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    frgmt = new WelcomeFragment();
                    break;
                case 1:
                    frgmt = new StoryFragment();
                    break;
                case 2:
                    frgmt = new CreateUserFragment();
                    break;
            }
